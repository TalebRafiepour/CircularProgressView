...
public class MainActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CheckBox indeterminate = findViewById(R.id.cb_indeterminate);
        indeterminate.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    circularProgress.startIndeterminate(2000);
                }else {
                    circularProgress.stopIndeterminate();
                }
            }
        });
